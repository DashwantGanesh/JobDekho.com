        ...
        <div className="flex items-center gap-12">
          ...
          {                                                /*ternary operator react*/
            ...
            <PopoverContent className="w-80">
              ...
              {/* div for avatar and name and bio ended here */}
              <div className="flex flex-col my-2 ">
                {
                  user && user.role === 'student' && (
                    <div className="flex w-fit items-center gap-2  ">
                  <User2 /> <Button variant="link" className=" text-gray-600 cursor-pointer"><Link to="/profile">View Profile</Link></Button>
                </div>
                  )
                }
                
                <div className="flex w-fit items-center gap-2  text-gray-600 ">
                  <LogOut /> <Button onClick={logoutHandler} variant="link" className=" text-gray-600 cursor-pointer">Logout</Button>
                </div>
              </div>
            </PopoverContent>
          </Popover>
